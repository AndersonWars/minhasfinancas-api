...
import com.anderson.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.anderson.minhasfinancas.api.dto.LancamentoDTO;
import com.anderson.minhasfinancas.exception.RegraNegocioException;
...
import com.anderson.minhasfinancas.model.enums.TipoLancamento;
...
public class LancamentoResource {
	...
	public ResponseEntity buscar(
		...
		@RequestParam("usuario") Long idUsario
			...
			Optional<Usuario> usuario =  usurioService.obterPorId(idUsario);
	...
	public ResponseEntity deletar(@PathVariable("id") Long id) {
		return service.obterPorId(id).map(entidade -> {
			...
			new ResponseEntity("Lancamento não encontrado na base de Dadois.", HttpStatus.BAD_REQUEST));
	}
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		Usuario usuario = usurioService.obterPorId(dto.getUsuario()).orElseThrow(() -> new RegraNegocioException("Usuário não encontrado para o Id informado"));
